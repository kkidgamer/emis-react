    ...
    <AnimatedBackground>
      <div className="relative z-20 flex items-center justify-center p-6 min-h-screen">
        <div className="max-w-5xl w-full flex flex-col md:flex-row gap-10 justify-center">
          ...
          {/* Worker Account Card */}
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-10 flex-1 border border-white/10 
                          shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 hover:-translate-y-2 group">
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 mb-6 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center 
              ...
              <button className="group relative px-8 py-3 font-semibold text-white rounded-full overflow-hidden 
                ...
                <span className="relative z-10">Select Worker</span>
                </Link>
              </button>
            </div>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-10 flex-1 border border-white/10 
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 mb-6 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center 
            ...
            >
                ...
                <span className="relative z-10">Select User</span>
                </Link>
              </button>
            </div>
          </div>
