...
const ClientLoginComponent = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post("https://emis-demm.onrender.com/api/client/login", data);
            if (res.data.user) {
                setLoading('');
    ...
    return (
        <div className='container mt-5' style={{ maxWidth: '500px' }}>
            <form onSubmit={handleSubmit} className='card shadow bg-light p-4 rounded'>
                ...
                <h2 className='text-center mb-4 text-success'>Client Login</h2>
                ...
                <div className="text-center">
                    <p>Don't have an account? {' '}
                        <Link to={'/register/user'} className='text-decoration-none'>Register</Link>
                    </p>
                </div>
            </form>
        </div>
