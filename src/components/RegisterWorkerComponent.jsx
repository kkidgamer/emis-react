          ...
          <div className="relative z-20 flex items-center justify-center px-4 sm:px-6 min-h-screen py-20">
            <div className="relative bg-white/10 backdrop-blur-xl p-8 max-w-md w-full rounded-3xl border border-white/20 shadow-2xl">
              <div className="text-center mb-8">
                ...
                <h2 className="text-3xl font-bold text-white mb-2">Register Worker</h2>
                <p className="text-gray-200">Join our network of skilled professionals</p>
              </div>
                ...
                {[
                  ...
                  <div key={field.name} className="relative">
                    ...
                    <input
                      type={field.type}
                      name={field.name}
                      className="w-full pl-12 pr-4 py-3 rounded-2xl bg-white/10 border border-white/20 
