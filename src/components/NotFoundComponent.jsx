  ...
  return (
    <AnimatedBackground>
      <div className="relative z-20 flex flex-col items-center justify-center px-4 sm:px-6 text-center min-h-screen">
        <div className="relative bg-white/10 backdrop-blur-xl p-12 rounded-3xl border border-white/20 shadow-2xl max-w-lg w-full">
          {/* 404 Number with glow effect */}
          <div className="relative mb-8">
            <div className="absolute inset-0 text-6xl sm:text-8xl font-black text-transparent bg-gradient-to-r from-blue-400 via-purple-500 to-cyan-400 bg-clip-text blur-sm opacity-50"></div>
            <h1 className="relative text-6xl sm:text-8xl font-black text-transparent bg-gradient-to-r from-blue-400 via-purple-500 to-cyan-400 bg-clip-text">
              404
            </h1>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={navigate}
              className="group relative px-6 py-3 font-bold text-white rounded-full overflow-hidden 
